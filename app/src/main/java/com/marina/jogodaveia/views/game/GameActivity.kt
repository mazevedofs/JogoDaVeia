...
import com.marina.jogodaveia.databinding.ActivityGameBinding
import com.marina.jogodaveia.models.Player
...
class GameActivity : AppCompatActivity() {
    ...
    private fun initDataBinding(player1: String, player2: String) { val activityGameBinding =
